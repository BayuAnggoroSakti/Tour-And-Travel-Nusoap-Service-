...
<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $result = $client->call('tambah_promo', array('nama' => $nama, 'isi' => $isi, 'tanggal_awal' => $tanggal_awal, 'tanggal_akhir' => $tanggal_akhir, 'isi' => $isi, 'gambar' => $file));
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <title>Tambah Promo Wisata - Travel</title>
                        ...
                        <div class="col-md-9 col-sm-9">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"> <a href="#collapseB1" data-toggle="collapse"> Tambah Promo Wisata </a> </h4>
                                </div>
