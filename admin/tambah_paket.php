...
<?php
    ...
    if (isset($_POST['submit']))
    {
        ...
        $result = $client->call('tambah_paket', array('nama' => $nama, 'tujuan' => $tujuan, 'durasi' => $durasi, 'harga' => $harga, 'isi' => $isi, 'gambar' => $file));
        ...
        if ($result == true){
            ...
            mysql_error($result);
            echo $nama.$harga.$tujuan.$isi.$file.$durasi;
...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <title>Tambah Paket Wisata - Travel</title>
                        ...
                        <div class="col-md-9 col-sm-9">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"> <a href="#collapseB1" data-toggle="collapse"> Tambah Paket Wisata </a> </h4>
                                </div>
                                ...
                                <form action="" accept-charset="utf-8" method="post" enctype="multipart/form-data" id="UserProfileForm" class="form-horizontal">
                                    <div class="panel-body">             
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <label class="col-sm-3 control-label">Tujuan Wisata</label>
                                            <div class="col-sm-9">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                           		<input type="number" name="durasi" required class="form-control">
                                            </div>
                                            </label>
                                        </div>
                                         <div class="form-group">
