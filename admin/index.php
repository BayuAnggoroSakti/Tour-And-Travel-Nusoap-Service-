...
if (isset($_POST['hapus_id_pw'])) {

    $id_pw = $_POST['hapus_id_pw'];
    ...
    $result = $client->call('hapus_paket', array('id_pw' => $id_pw));
                                    ...
                                    <form>
                                        ...
                                        <div class="col-sm-12 login-form">
                                         <div class="before-table">
                                                <div class="row">
                                                    <div class="col-xs-9">
                                                        <a href="tambah_paket.php" class="btn btn-custom">ADD DATA</a>
                                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><center><?php echo $tujuan; ?></center></td>
                                                <td><center><?php echo $durasi; ?></center></td>
                                                    ...
                                                    <center>
                                                        <div class="col-xs-12">
                                                            <form action="edit_paket.php" method="post">
                                                                <button id='submit' type='submit' name="id_pw" value="<?php echo $id_pw; ?>" class="btn btn-block label-warning"><font color="white">edit</font></button>
                                                            </form>
                                                              <form action='' method='post'>
                                                                <button id='submit' type='submit' name="hapus_id_pw" value="<?php echo $id_pw; ?>" class="btn btn-block label-danger" onclick="return confirm('Delete this item? <?php echo $id_pw; ?>')"><font color="white">delete</font></button>
                                                            </form>
                                                        </div>
