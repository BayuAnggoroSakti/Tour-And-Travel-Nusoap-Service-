...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        <meta charset="utf-8">
        <title>Paket Wisata - Travel</title>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="widget-item">
                            <h3 class="widget-title">Promo Wisata</h3>
                              <?php
                                                ...
                                                ?>
                                                     <div class="post-small">
                                                        <div class="post-date">
                                                          <img src="admin/images/<?php echo $gambar; ?>" width="70px" height="70px">
                                                        </div> <!-- /.post-thumb -->
                                                        <div class="post-content">
                                                            <h4><a href="detail_promo.php?id_promo=<?php echo $id_promo; ?>"><?php echo $nama; ?></a></h4>
